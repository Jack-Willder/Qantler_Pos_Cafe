...
export default function Billing() {
  ...
  return (
    ...
    <div className="content-area">
      <div className="inventory-content" id="salesreport-content">
        <div className="statusbar">
          <div className="titlebar">
            <IconPosCafe color="black" />
            <div className="itemrequest-inventorytitle">Customer Report</div>
          </div>
        ...
        <div className="inventory-card grid-filter-card">
          <div className="align-option-group">
            <div className="option-group-name">Filter By</div>
          ...
          <div className="align-option-group">
            ...
            <input className="opg-date-select" id="filter-date-from" type="date" value="2024-05-20"></input>
          </div>
          <div className="align-option-group">
            <div className="option-group-name">Date To</div>
            <input className="opg-date-select" id="filter-date-to" type="date" value="2024-05-20"></input>
          </div>
          <div className="t-bfilter-group">
            <div className="t-bfilter option-select">
              <IconPosCafe color="black" />
        ...
        <div className="inventory-card grid-main-table-card">
          <div className="tablebar">
            <div className="align-title">
              <div className="tabletitle">Report List</div>
              <div className="tableitems">Total 128 items found</div>
            </div>
          </div>
          <table id="salesreport-table" className="w-full">
            <thead>
              <tr>
                <td>Item</td>
                <td>Sold Date</td>
