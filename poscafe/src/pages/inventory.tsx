            ...
            <tbody>
              {inventorylist.map((item, index) => (
                <tr className="border border-gray-100" key={index} onClick={() => {
                  ...
                  <td><div className="p-0.5 text-ss-55 text-center text-green-500 bg-green-100 rounded-sm flex items-center justify-center justify-self-center w-fit">{"In Stock"}</div></td>
          ...
          <div className="w-full flex justify-between">
            <div>
              <div className="flex items-center">
                ...
                <select id="entriescount" className="border border-gray-200 text-ss-65 p-1 rounded-sm mx-2  max-[820px]:text-ss-50">
            ...
            <div>
              <div className="flex items-center gap-2  max-[820px]:gap-1">
                <div className="p-2  max-[820px]:p-1.5 text-ss-65 border border-gray-200 rounded-sm aspect-square h-3/5 text-center flex items-center justify-center"><IconPosCafe icon="dleft" color="black" size={12} /></div>
                <div className="p-2  max-[820px]:p-1.5 text-ss-65 border border-gray-200 rounded-sm aspect-square h-3/5 text-center flex items-center justify-center"><IconPosCafe icon="left" color="black" size={12} /></div>
                <div className="p-2.5  max-[820px]:p-2 text-ss-65 border border-gray-200 rounded-sm aspect-square h-3/5 text-center flex items-center justify-center bg-gpurple text-white" onClick={() => setCurrentPage(1)}>1</div>
                <div className="p-2.5  max-[820px]:p-2 text-ss-65 border border-gray-200 rounded-sm aspect-square h-3/5 text-center flex items-center justify-center" onClick={() => setCurrentPage(2)}>2</div>
                <div className="p-2.5  max-[820px]:p-2 text-ss-65 border border-gray-200 rounded-sm aspect-square h-3/5 text-center flex items-center justify-center" onClick={() => setCurrentPage(3)}>3</div>
                <div className="p-2.5  max-[820px]:p-2 text-ss-65 border border-gray-200 rounded-sm aspect-square h-3/5 text-center flex items-center justify-center" onClick={() => setCurrentPage(4)}>4</div>
                <div className="p-2.5  max-[820px]:p-2 text-ss-65 border border-gray-200 rounded-sm aspect-square h-3/5 text-center flex items-center justify-center" onClick={() => setCurrentPage(5)}>5</div>
                <div className="p-2.5  max-[820px]:p-2 text-ss-65 border border-gray-200 rounded-sm aspect-square h-3/5 text-center flex items-center justify-center">...</div>
                <div className="p-2.5  max-[820px]:p-2 text-ss-65 border border-gray-200 rounded-sm aspect-square h-3/5 text-center flex items-center justify-center" onClick={() => setCurrentPage(13)}>13</div>
                <div className="p-2  max-[820px]:p-1.5 text-ss-65 border border-gray-200 rounded-sm aspect-square h-3/5 text-center flex items-center justify-center"><IconPosCafe icon="right" color="black" size={12} /></div>
                <div className="p-2  max-[820px]:p-1.5 text-ss-65 border border-gray-200 rounded-sm aspect-square h-3/5 text-center flex items-center justify-center"><IconPosCafe icon="dright" color="black" size={12} /></div>
              </div>
            </div>
            <div className="align-tshow flex items-center">
              <div className="flex items-center max-[820px]:justify-center">
                <div className="text-ss-55  max-[820px]:text-ss-50">showing {currentPage} to {(inventorylist.length) ? inventorylist.length : 0} of 128 entries</div>
              </div>
            </div>
          </div>
        </div>
